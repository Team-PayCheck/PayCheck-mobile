...
import WorkCard from "../weeklyCalendar/WorkCard";
import { colors } from "../../../constants/colors";
import type { WorkItem } from "../../../types/worker.types";

interface SelectedDateWorkListProps {
  works: WorkItem[];
  onPressAdd?: () => void;
  onPressCorrectionRequest?: (work: WorkItem) => void;
}

const SelectedDateWorkList: React.FC<SelectedDateWorkListProps> = ({
  works,
  onPressAdd,
...
export default SelectedDateWorkList;
